...
LOGGER: logging.Logger = create_logger("tax_report_au")
...
class Generator(AbstractODSGenerator):
    MIN_ROWS: int = 20
    MAX_COLUMNS: int = 20
    OUTPUT_FILE: str = "tax_report_au.ods"
    ...
    def generate(
        ...
        template_path: str = self._get_template_path("tax_report_au", country, generation_language)
